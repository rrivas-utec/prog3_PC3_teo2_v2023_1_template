...
#ifndef PROG3_PC3_TEO2_V2023_1_GRAFO_H
#define PROG3_PC3_TEO2_V2023_1_GRAFO_H
...
public:
    ...
    void dfs (KeyType key, UnaryFunction fun) {
        ...
        while(!s.empty()) {
            // Paso #3
            auto vx_top = s.top();
            // Paso # 4.0 Buscar el primer adyacente no visitado
...
#endif //PROG3_PC3_TEO2_V2023_1_GRAFO_H
